...
public class InvoiceCreation implements HttpHandler {
    @Override
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            File html = new File("/home/jonatan/codecool/module3/TW2/invoice/src/main/java/com/codecool/invoice/frontend/create.html");
